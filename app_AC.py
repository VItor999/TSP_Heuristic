...
@app.callback(
    ...
    [
        ...
        State("beta_", "value"),
        State("rho_", "value"),
        State("q-constant", "value"),
        State("generations_", "value"),
        State("theme-store", "data"),
    ],
)
def update_plots(n_clicks, selected_option, uploaded_data, num_cities, alpha,
                 beta, rho, q_constant, generations,theme):
    ...
    print("Ant Colony")
    TS_distance_label = f"Distance: {AC_best_solution_distance:5.3f} m"
    ...
    add_plot_traces(fig2, data_model["locations"], AC_best_route, is_3d,current_theme)
    fig2.update_layout(
        title=f"Ant Colony: {AC_best_solution_distance:5.3f} m",
        plot_bgcolor=current_theme["plotlyTheme"]["layout"]["plot_bgcolor"],  # Use theme for plot background
        paper_bgcolor=current_theme["plotlyTheme"]["layout"]["paper_bgcolor"],  # Use theme for paper background
        font={"color": current_theme["color"]},  # Use theme font color
        xaxis_title="X [m]",
    ...
    return fig1, fig2, AC_solution, benchmark_distance_label, TS_distance_label
...
if __name__ == "__main__":
    app.run_server(debug=False, port=12347)
